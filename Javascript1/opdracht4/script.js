...
console.log(zin1 + " " + zin1.length);
console.log(zin2 + " " + zin2.length);
console.log(zin3 + " " + zin3.length);
console.log(zin4 + " " + zin4.length);
console.log(zin5 + " " + zin5.length);
console.log(zin6 + " " + zin6.length);
console.log(zin7 + " " + zin7.length);
console.log(zin8 + " " + zin8.length);
console.log(zin9 + " " + zin9.length);
console.log(zin10 + " " + zin10.length);
